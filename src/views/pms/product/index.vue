  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Input Search">
            <el-input style="width: 203px" v-model="listQuery.keyword"></el-input>
          </el-form-item>
          <el-form-item label="Id">
            <el-input style="width: 203px" v-model="listQuery.productSn"></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="productTable" :data="list" style="width: 100%" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="Sell" width="100" align="center">
        ...
        <el-table-column label="Audit Status" width="100" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button type="text" @click="handleShowVerifyDetail(scope.$index, scope.row)">Detail
              </el-button>
            </p>
          </template>
        </el-table-column>
        <el-table-column label="Action" width="160" align="center">
          <template slot-scope="scope">
            <p>
              <el-button size="mini" @click="handleShowProduct(scope.$index, scope.row)">View
              </el-button>
              <el-button size="mini" @click="handleUpdateProduct(scope.$index, scope.row)">Edit
              </el-button>
            </p>
            <p>
              <el-button size="mini" @click="handleShowLog(scope.$index, scope.row)">Log
              </el-button>
    ...
    <div class="batch-operate-container">
      <el-select size="small" v-model="operateType" placeholder="Action">
    ...
    <el-dialog title="Edit" :visible.sync="editSkuInfo.dialogVisible" width="40%">
      <span>Sn：</span>
      <span>{{ editSkuInfo.productSn }}</span>
      <el-input placeholder="Search" v-model="editSkuInfo.keyword" size="small" style="width: 50%;margin-left: 20px">
      ...
      <el-table style="width: 100%;margin-top: 20px" :data="editSkuInfo.stockList" border>
        ...
        <el-table-column label="Low Stock" width="100" align="center">
          <template slot-scope="scope">
