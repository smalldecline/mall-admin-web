  ...
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" class="form-inner-container" size="small">
      <el-form-item label="Attribute Type:">
        <el-select v-model="value.productAttributeCategoryId" placeholder="Select attribute type"
      ...
      <el-form-item label="Product Specification:">
        ...
        <el-table style="width: 100%;margin-top: 20px" :data="value.skuStockList" border>
          ...
          <el-table-column label="Sale Price" width="100" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="Product Stock" width="80" align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.stock"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="Low Stock Value" width="80" align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.lowStock"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="SKU Code" width="160" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="Action" width="80" align="center">
            <template slot-scope="scope">
              <el-button type="text" @click="handleRemoveProductSku(scope.$index, scope.row)">Delete
              </el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-button type="primary" style="margin-top: 20px" @click="handleRefreshProductSkuList">Refresh List
        </el-button>
        <el-button type="primary" style="margin-top: 20px" @click="handleSyncProductSkuPrice">Sync Price
        </el-button>
        <el-button type="primary" style="margin-top: 20px" @click="handleSyncProductSkuStock">Sync Stock
        </el-button>
      </el-form-item>
      <el-form-item label="Attribute Images:" v-if="hasAttrPic">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">Previous Step, Fill in Product Promotion</el-button>
        <el-button type="primary" size="medium" @click="handleNext">Next Step, Select Product Association</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
