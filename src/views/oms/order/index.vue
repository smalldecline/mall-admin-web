<template>
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Receiver:">
            <el-input v-model="listQuery.receiverKeyword" class="input-width" placeholder="Receiver Name/Phone Number"></el-input>
          </el-form-item>
    ...
    <el-dialog
      ...
      <span style="vertical-align: top">Operation Note:</span>
      <el-input
        style="width: 80%"
        type="textarea"
        :rows="5"
